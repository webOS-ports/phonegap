...
channel.onHide = cordova.addDocumentEventHandler('hide');
channel.onRelaunch = cordova.addDocumentEventHandler('relaunch');
...
// Event to indicate a show window event
channel.create('onShow');

// Event to indicate a hide window event
channel.create('onHide');

// Event to indicate a relaunch window event
channel.create('onRelaunch');
